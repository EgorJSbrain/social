    ...
    return ( 
            ...
            <div className={style.avatarb_lock}>
                ...
                <img src={props.profile.photos.large} alt='' className={style.user_avatar}></img>
                {
                    ...
                    <label for="upload" className={style.label_add_avatar}>Add photo</label>
                </>
                }
            </div>
                    ...
                    <div>
                        {
                            isOwner && <>
                                        ...
                                        <label for="edit"><img src="https://cdn1.iconfinder.com/data/icons/pinterest-ui/48/jee-07-512.png" className={style.edit_label} alt=""/></label>
                                       </>
                        }
                        ...
                        <div className={style.discription_block}>
                            {Object.keys(props.profile.contacts).map(key => {    
                                return <div className={style.user_discription_block}>
